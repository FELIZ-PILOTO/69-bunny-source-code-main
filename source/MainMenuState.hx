...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("Playing The VS 69 THE BUNNY Mod...", null);
		#end
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "V.S. 69 THE BUNNY' v" + psychEngineVersion, 12);
